...
uint8_t gmult_lookup_table[8][256] = {
{ // gmult(0x02, b);
...
#define gmultl(o,b) gmult_lookup_table[o][b]
void coef_mult_lookup(int lookup_table_offset, uint8_t *b, uint8_t *d) {
